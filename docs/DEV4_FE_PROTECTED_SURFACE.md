...
| 2026-07-14 | **PR10 done** (`5b60ca8`) — courses catalog/detail + lesson room + bookmarks demo fidelity; CourseCard shared restyle; list/enroll/complete/bookmark/notes/comments APIs locked. Test `/courses`, `/courses/[id]`, `/lessons/[id]`, `/bookmarks`. |
